...
import it.vfsfitvnm.providers.innertube.models.AccountInfo
...
import it.vfsfitvnm.providers.innertube.models.WatchEndpoint.WatchEndpointMusicSupportedConfigs.WatchEndpointMusicConfig.Companion.MUSIC_VIDEO_TYPE_ATV
import it.vfsfitvnm.providers.innertube.models.YouTubeClient
import it.vfsfitvnm.providers.innertube.models.YouTubeClient.Companion.WEB
import it.vfsfitvnm.providers.innertube.models.YouTubeClient.Companion.WEB_REMIX
import it.vfsfitvnm.providers.innertube.models.YouTubeLocale
import it.vfsfitvnm.providers.innertube.models.getContinuation
import it.vfsfitvnm.providers.innertube.models.getItems
import it.vfsfitvnm.providers.innertube.models.oddElements
import it.vfsfitvnm.providers.innertube.models.response.AccountMenuResponse
import it.vfsfitvnm.providers.innertube.models.response.BrowseResponse
import it.vfsfitvnm.providers.innertube.models.response.CreatePlaylistResponse
import it.vfsfitvnm.providers.innertube.models.response.GetQueueResponse
import it.vfsfitvnm.providers.innertube.models.response.GetSearchSuggestionsResponse
import it.vfsfitvnm.providers.innertube.models.response.GetTranscriptResponse
import it.vfsfitvnm.providers.innertube.models.response.NextResponse
import it.vfsfitvnm.providers.innertube.models.PlayerResponse
import it.vfsfitvnm.providers.innertube.models.response.SearchResponse
import it.vfsfitvnm.providers.innertube.requests.AlbumPage
import it.vfsfitvnm.providers.innertube.requests.ArtistItemsContinuationPage
import it.vfsfitvnm.providers.innertube.requests.ArtistItemsPage
...
import it.vfsfitvnm.providers.innertube.requests.HistoryPage
import it.vfsfitvnm.providers.innertube.requests.HomePage
import it.vfsfitvnm.providers.innertube.requests.LibraryContinuationPage
import it.vfsfitvnm.providers.innertube.requests.LibraryPage
import it.vfsfitvnm.providers.innertube.requests.MoodAndGenres
import it.vfsfitvnm.providers.innertube.requests.NewReleaseAlbumPage
import it.vfsfitvnm.providers.innertube.requests.NextPage
import it.vfsfitvnm.providers.innertube.requests.NextResult
import it.vfsfitvnm.providers.innertube.requests.PlaylistContinuationPage
...
import it.vfsfitvnm.providers.innertube.requests.SearchResult
import it.vfsfitvnm.providers.innertube.requests.SearchSuggestionPage
import it.vfsfitvnm.providers.innertube.requests.SearchSummary
import it.vfsfitvnm.providers.innertube.requests.SearchSummaryPage
...
/**
 * Parse useful data with [it.vfsfitvnm.providers.innertube.Innertube] sending requests.
...
object YouTube {
    ...
    suspend fun explore(): Result<ExplorePage> = runCatching {
        ...
        ExplorePage(
            ...
            moodAndGenres = response.contents
                ...
                ?.sectionListRenderer
                ?.contents
                ?.filter { it.gridRenderer != null }
                ?.mapNotNull(MoodAndGenres::fromSectionListRendererContent)
                .orEmpty()
        )
    }
